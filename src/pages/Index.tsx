...
const Index = () => {
  ...
  const handleStudentLogin = (studentId: string, registrationNumber: string) => {
    setLoggedInStudent({ id: studentId, registrationNumber });
  };
      ...
      <main className="container mx-auto px-4 pt-24 pb-16">
        {loggedInStudent ? (
          <div className="flex flex-col items-center">
            ...
            <StudentInfoPanel studentId={loggedInStudent.id} />
          </div>
        ) : (
          <div className="flex flex-col items-center">
            {/* Hero Section */}
            <div className="mb-12 text-center animate-fade-in">
              ...
              <h1 className="mb-4 text-4xl font-bold sm:text-5xl">
                Welcome to <span className="gradient-text">AU Site</span>
              </h1>
